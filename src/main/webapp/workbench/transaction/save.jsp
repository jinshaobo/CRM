	...
	<script type="text/javascript">
		...
		$(function (){
			...
			$("#create-stage").change(function (){
				...
				var posibility = json[stage];//stage是动态生成的只能采用这种形式，不能json.stage
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="search-name" class="form-control" style="width: 300px;" placeholder="请输入联系人名称，支持模糊查询">
						    <span class="glyphicon glyphicon-search form-control-feedback"></span>
						  </div>
						</form>
					</div>
...
<%--				  <option>聊天</option>--%>
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="01e10ddfce344c12a505d2cb77bb18c8">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="cbe49d84075a47caa1662bd001b6c820">
			</div>
		</div>
